...
def find_nearby_therapists_by_location(location: str) -> str:
    ...
    places_result = gmap.places_nearby(location=(lat, lng), radius=5000, keyword='psychotherapist')
    ...
    for place in top_results:
        ...
        details= gmap.place(place_id=place['place_id'], fields=['formatted_phone_number'])
        phone = details.get('result', {}).get('formatted_phone_number', 'No phone provided ')
